...
export function createRunFromCandidate(
  ...
  const deepNodes = [
    ...
    newNode("release-editorial", "标题、简介与 Show Notes", "production", "发行编辑", "release.copy", ["artifact-script", "artifact-blueprint", "artifact-sources"], ["artifact-release-copy"], "pending", ["script-repair"]),
    newNode("visual-pack", "单集封面与章节视觉", "production", "视觉编辑", "image.generate", ["artifact-brief", "artifact-blueprint", "artifact-script"], ["artifact-visuals"], "pending", ["script-repair"]),
    newNode("voice-casting", "选角与声音试演", "production", "声音导演", "voice.synthesize", ["artifact-script", "artifact-cast"], ["artifact-voices"], "pending", ["script-repair"]),
    newNode("music-cue-sheet", "音乐、声景与留白", "production", "声音设计师", "music.plan", ["artifact-script", "artifact-emotion"], ["artifact-cues"], "pending", ["script-repair"]),
