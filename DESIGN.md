...
- 2026-08-29: Provider research and executable capability are different states. Qwen and Doubao remain visible for cost comparison but cannot be selected until an adapter exists; the current release path supports local macOS table reads and configured ElevenLabs v3 dialogue rendering.
